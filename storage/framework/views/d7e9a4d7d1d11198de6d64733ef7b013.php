...
<?php $__env->startSection('title', 'Ecommerce Dashboard'); ?>
...
<?php $__env->startPush('style'); ?>
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('library/owl.carousel/dist/assets/owl.carousel.min.css')); ?>">
    <link rel="stylesheet"
        href="<?php echo e(asset('library/owl.carousel/dist/assets/owl.theme.default.min.css')); ?>">
    <link rel="stylesheet"
        href="<?php echo e(asset('library/flag-icon-css/css/flag-icon.min.css')); ?>">
<?php $__env->stopPush(); ?>
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <img class="mr-3 rounded"
                                        width="55"
                                        src="<?php echo e(asset('img/products/product-3-50.png')); ?>"
                                        alt="product">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded"
                                        width="55"
                                        src="<?php echo e(asset('img/products/product-4-50.png')); ?>"
                                        alt="product">
                                    <div class="media-body">
                                        <div class="float-right">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded"
                                        width="55"
                                        src="<?php echo e(asset('img/products/product-1-50.png')); ?>"
                                        alt="product">
                                    <div class="media-body">
                                        <div class="float-right">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded"
                                        width="55"
                                        src="<?php echo e(asset('img/products/product-5-50.png')); ?>"
                                        alt="product">
                                    <div class="media-body">
                                        <div class="float-right">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\laravel_backend_kedai\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>